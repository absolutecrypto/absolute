    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    QString version = tr("Absolute Core") + " " + tr("version") + " " + QString::fromStdString(FormatFullVersion());
    ...
    if (helpMode == about)
    {
        setWindowTitle(tr("About Absolute Core"));
        ...
        QString header = tr("Usage:") + "\n" +
            "  absolute-qt [" + tr("command-line options") + "]                     " + "\n";
...
All the Absolute in your wallet is comprised of different \"inputs\" which you can think of as separate, discrete coins.<br> \
...
These denominations are 0.01 ABS, 0.1 ABS, 1 ABS and 10 ABS -- sort of like the paper money you use every day.</li> \
    ...
    QWidget(parent, f)
{
    ...
    layout->addWidget(new QLabel(
        tr("Absolute Core is shutting down...") + "<br /><br />" +
