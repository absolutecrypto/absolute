...
Only requiring some minor changes is absolute.cpp.
...
Changes to absolute.cpp
----------------------
absolute.cpp is the entry point into bitcoin-qt, and as such, will require some minor modifications to provide hooks for
