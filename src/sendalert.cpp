...
2. run absoluted with -printalert or -sendalert like this:
   /path/to/absoluted -printalert
...
void ThreadSendAlert(CConnman& connman)
{
    ...
    alert.strComment    = "";
    alert.strStatusBar  = "URGENT: Upgrade required: see https://www.absolutecrypto.com";

    // Set specific client version/versions here. If setSubVer is empty, no filtering on subver is done:
    // alert.setSubVer.insert(std::string("/Absolute Core:0.12.0.58/"));
