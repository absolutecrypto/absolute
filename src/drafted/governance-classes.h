 ...
 *
 *   // network
 *   CAbsoluteNetwork lvl, network-type, network-status, network-error, milestone-status*
...
// // root node
class CAbsoluteNetwork : public CGovernanceObject
{
private:
    std::string strName;
    std::string strURL;
...
public:
    CAbsoluteNetwork(UniValue objIn)
    {
...
// // can be under: AbsoluteNetwork
// //   -- signature requirements : Key1(User)
// class CAbsoluteNetworkVariable : public CGovernanceObject
// {
// private:
