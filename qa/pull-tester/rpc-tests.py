...
testScripts = [
    ...
    'invalidblockrequest.py', # NOTE: needs absolute_hash to pass
...
testScriptsExt = [
    'bip9-softforks.py',
    'bip65-cltv.py',
    'bip65-cltv-p2p.py', # NOTE: needs absolute_hash to pass
    'bip68-sequence.py',
    'bipdersig-p2p.py', # NOTE: needs absolute_hash to pass
    'bipdersig.py',
