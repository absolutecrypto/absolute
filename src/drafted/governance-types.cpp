...
GovernanceObjectType GovernanceStringToType(std::string strType) {
    ...
    if(strType == "AbsoluteNetwork") type = AbsoluteNetwork;
    if(strType == "AbsoluteNetworkVariable") type = AbsoluteNetworkVariable;
...
std::string GovernanceTypeToString(GovernanceObjectType type) {
    ...
    if(type == AbsoluteNetwork) s = "AbsoluteNetwork";
    if(type == AbsoluteNetworkVariable) s = "AbsoluteNetworkVariable";
