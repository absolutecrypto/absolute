...
Absolute Core is a multithreaded application, and deadlocks or other multithreading bugs
...
However, in open source software such as Absolute Core, where everyone uses
...
pay attention to for reviewers of Absolute Core code.

General Absolute Core
----------------------
